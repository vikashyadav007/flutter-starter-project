...
import 'package:starter_project/features/shift_management/presentation/providers/start_new_shift_provider.dart';
import 'package:starter_project/features/shift_management/presentation/widgets/add_consumables_listing.dart';
                        ...
                        children: [
                          ...
                          CustomTextField(
                              ...
                              onChanged: (value) => {
                                    ref
                                        .read(
                                            startingCashAmountProvider.notifier)
                                        .state = value,
                                  }),
                        ],
                      );
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: selectedStaff == null ||
                                    ...
                                    : () {
                                        ref
                                            .read(
                                                startNewShiftProvider.notifier)
                                            .creaetNewShift();
                                      },
                                child: const Text(
                                  "Start Shift",
