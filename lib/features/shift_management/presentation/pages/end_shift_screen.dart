...
import 'package:fuel_pro_360/features/shift_management/presentation/providers/end_shift_provider.dart';
import 'package:fuel_pro_360/features/shift_management/presentation/providers/provider.dart';
import 'package:fuel_pro_360/features/shift_management/presentation/widgets/cash_count.dart';
import 'package:fuel_pro_360/features/shift_management/presentation/widgets/end_shift_consumables_reconciliation.dart';
import 'package:fuel_pro_360/features/shift_management/presentation/widgets/end_shift_header.dart';
import 'package:fuel_pro_360/features/shift_management/presentation/widgets/end_shift_meter_readings.dart';
import 'package:fuel_pro_360/features/shift_management/presentation/widgets/other_expenses.dart';
import 'package:fuel_pro_360/features/shift_management/presentation/widgets/shift_financial_summary.dart';
import 'package:fuel_pro_360/features/shift_management/presentation/widgets/testing_fuel_reading.dart';
import 'package:fuel_pro_360/features/shift_management/presentation/widgets/total_sales_card.dart';
                            ...
                            Row(
                              children: [
                                ...
                                detailRow(
                                  label: 'Pump:',
                                  value:
                                      selectedShift?.readings?[0].pumpId ?? "",
                                  flex: 1,
                                )
                              ],
                            ),
                        ...
                        children: [
                          Consumer(
                            builder: (context, ref, child) {
                              ...
                              final meterReadings =
                                  ref.watch(pumpClosingReadingsProvider);

                              bool isValid = false;

                              if (meterReadings.isNotEmpty) {
                                isValid = meterReadings.every((reading) =>
                                    reading.totalLiters.isNotEmpty &&
                                    (double.tryParse(reading.totalLiters)! >
                                        0.0));
                              }
